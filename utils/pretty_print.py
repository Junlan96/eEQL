...
def sym_pp(W_list, funcs, var_names, threshold=0.001, n_double=0):
...
def network(weights, funcs, var_names, threshold=0.001):
...
def filter_mat(mat, threshold=0.001):
...
def filter_expr(expr, threshold=0.001):
